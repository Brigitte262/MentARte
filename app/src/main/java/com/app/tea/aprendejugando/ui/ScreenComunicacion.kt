...
fun ComunicacionScreen() {
    ...
    BoxWithConstraints(
        ...
        val nubeSize = if (isTablet) 180.dp else 150.dp

        // El resto del contenido va dentro
        Column(
